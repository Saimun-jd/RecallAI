...
import { DIALOG_VARIANTS, BACKDROP_VARIANTS } from '../../lib/motion';
      ...
      {isOpen && citation && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <motion.div
            ...
            animate="animate"
            exit="exit"
            className="relative w-full max-w-xl bg-surface border-2 border-border-default rounded-2xl shadow-neo-lg z-10 overflow-hidden flex flex-col max-h-[85vh]"
          >
            {/* Header */}
            <div className="p-4 border-b-2 border-border-default bg-surface-container-low flex items-center justify-between shrink-0">
              ...
              <button
                type="button"
                onClick={onClose}
                className="w-8 h-8 flex items-center justify-center rounded-lg border border-border-default bg-surface hover:bg-surface-container text-on-surface-variant hover:text-on-surface transition-all cursor-pointer shadow-neo-xs active:translate-x-[1px] active:translate-y-[1px]"
            ...
            <div className="p-5 overflow-y-auto space-y-4 custom-scrollbar">
              <div className="space-y-2">
                ...
                <div className="p-4 rounded-xl border-2 border-border-default bg-surface-container-lowest text-xs text-on-surface font-mono leading-relaxed select-text whitespace-pre-wrap shadow-neo-xs">
            ...
            <div className="p-3.5 border-t-2 border-border-default bg-surface flex items-center justify-between shrink-0 gap-3">
              ...
              {citation.document_id && (
                <Button
                  ...
                  className="text-xs gap-1.5 shadow-neo active:translate-x-[1px] active:translate-y-[1px]"
                >
                  <BookOpen size={14} />
