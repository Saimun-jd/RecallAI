...
class FlashcardGenerationService:
    ...
    def _check_entitlement(cls, workspace_id: str, is_byok: bool) -> None:
        ...
        EntitlementService.require_feature(workspace_id, "flashcards")
    ...
    async def generate_flashcards(
        ...
        try:
            # 4. Retrieve representative learning chunks
            ...
            # Automatically register flashcards as durable learning items for spaced repetition review
            try:
                learning_items_data = [
                    {
                        "id": c["id"],
                ...
                logger.warning("Failed to initialize learning items for flashcard set %s: %s", created_set["id"], e)
